...
RegisterNetEvent('md-stashes:client:doray', function()
	...
	if input[4] == ''then else input[4] = ", item = '" .. input[4] .. "'" end
	if input[5] == ''then else input[5] = ", slots = " .. input[5] .. "" end
	if input[6] == ''then else input[6] = ", weight = " .. input[6] .. "" end
	if input[7] == ''then else input[7] = ", cid = '" .. input[7] .. "'" end
	local copy = nameloc .. input[2] .. "" .. input[3] .. "" .. input[4] .. "" .. input[5] .. "" .. input[6].. "" .. input[7] .. "},"
